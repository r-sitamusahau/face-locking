...
try:
    ...
    if hasattr(mp, "solutions"):
        ...
        raise ImportError("mediapipe.solutions unavailable")
except Exception as e:
    mp = None
    _MP_IMPORT_ERROR = e
    _USE_TASKS_API = True
    from .mediapipe_facemesh import get_face_mesh
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Multi-face recognition demo")
    parser.add_argument(
        "--camera",
        type=int,
